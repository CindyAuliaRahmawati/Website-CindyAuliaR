      ...
      animation: blink 1s infinite;
        ...
        <strong style="color: red;">Faktor penyebab underweight:</strong>
          <ul style="list-style-type: none; padding: 0;">
            ...
            <li><span style="display: inline-block; width: 10px; height: 10px; border-radius: 10%; background-color: red; margin-right: 10px; vertical-align: left;"></span>Metabolism tinggi: Proses metabolsime yang tinggi dan cepat bisa membuat berat bdan tidak bertambah banyak meskipun sudah mengkonsumsi makanan berkalori tinggi.</li>
            <li><span style="display: inline-block; width: 10px; height: 10px; border-radius: 10%; background-color: red; margin-right: 10px; vertical-align: left;"></span>Sering melakukan aktivitas fisik: Melakukan aktivitas fisik berintensitas tinggi membuat tubuh membakar sebagian besar kalori sehingga bisa menyebabkan berat bdan turun. Kondisi ini kerap dialami oleh seseorang yang berprofesi sebagai atlet.</li>
